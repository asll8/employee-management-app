...
function importMapsPlugin(config = {}) {
    const injectSettings = (0, utils_js_1.normalizeInjectSetting)(config.inject);
    ...
    return {
        ...
        transform(context) {
            ...
            let toInject = injectSettings.find(i => (0, utils_js_1.shouldInject)(context.path, i));
            ...
            if (importMapId === -1) {
                ...
                const documentBaseUrl = (0, utils_js_1.getDocumentBaseUrl)(context, baseNode);
                ...
                try {
                    ...
                    if (toInject) {
                        ...
                        importMap = (0, utils_js_1.mergeImportMaps)(parsedImportMapToInject, importMap);
            ...
            for (const script of scripts) {
                ...
                if (src) {
                    (0, parse5_utils_1.setAttribute)(script, 'src', (0, utils_js_1.withImportMapIdParam)(src, String(importMapId)));
                }
            }
            ...
            for (const link of links) {
                ...
                if (href) {
                    (0, parse5_utils_1.setAttribute)(link, 'href', (0, utils_js_1.withImportMapIdParam)(href, String(importMapId)));
                }
            }
        ...
        transformImport({ source, context }) {
            const importMapId = (0, utils_js_1.getRequestImportMapId)(context, importMapsIdsByHtmlPath);
            if (importMapId == null) {
                return;
            }
            return (0, utils_js_1.withImportMapIdParam)(source, String(importMapId));
        },
        /**
        ...
        resolveImport({ source, context }) {
            ...
            if (!data) {
                throw Error(`Something went wrong resolving an import map. Could not find import map with id ${importMapId}.` +
                    ` Are you adding the URL search parameter ${utils_js_1.IMPORT_MAP_PARAM} manually?`);
            }
